...
export class EurComponent {
  ...
  readonly paymentInfo = {
    ...
    '60 day escrow window</span> to prevent fraudulent purchases.',
    body1: 'You will be charged for your cryptocurrencies tokens today, and be issued pending tokens in your Nano Wallet as a certificate of ' +
    'cryptocurrencies ownership. After the 60 day window your cryptocurrencies will be automatically transferred to your Nano wallet account.',
    body2: 'We are not responsible for any funds lost due to mistyped amounts or wallets. Please double check your entries carefully ' +
    'when completing purchase.',
